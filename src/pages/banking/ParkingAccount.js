...
const ParkingAccount = ({
 ...
 {isAdmin && isAdmin() && (
 <>
  {/* 🗑️ [2026-07-25] '파킹 복구(비활성)' 탭 제거 — 2026-06-22에 봉인된 기능이라 눌러도
      비활성 안내만 떴다(죽은 UI). 비멱등 머니프린터 코드가 번들에 남아 있는 것도 위험해
      버튼과 핸들러를 함께 삭제한다. 복구가 필요하면 git history(ParkingAccount.js)를 참조. */}
 <button
