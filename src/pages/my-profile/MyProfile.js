      ...
      <div className="w-full max-w-4xl mx-auto px-4 md:px-6 py-6">
        ...
        <div className="bg-gradient-to-br from-[#1e1e3f] to-[#16213e] rounded-[20px] p-6 mb-6 border-2 border-gray-700">
          ...
          <div className="flex flex-col gap-2">
            {/* 현재 학급 코드 표시 */}
            <div className="p-4 bg-gray-100 dark:bg-slate-900 rounded-xl border border-gray-700 mb-2">
            ...
            <button
              ...
              className="flex items-center gap-3 p-4 bg-gray-100 dark:bg-slate-900 rounded-xl border border-gray-700 cursor-pointer transition-all duration-200 hover:border-[#a78bfa]/50"
            >
            ...
            <button
              onClick={logout}
              className="flex items-center gap-3 p-4 bg-gray-100 dark:bg-slate-900 rounded-xl border border-gray-700 cursor-pointer transition-all duration-200 hover:border-gray-500 mt-2"
            >
        ...
        >
          ...
          >
            ...
            <input
              ...
              maxLength={10}
              className="w-full p-3.5 bg-gray-100 dark:bg-slate-900 border-2 border-gray-700 rounded-xl text-cyber-text text-sm mb-3 focus:border-[#a78bfa] focus:outline-none"
            />
        ...
        >
          ...
          >
            ...
            <input
              ...
              placeholder="현재 비밀번호"
              className="w-full p-3.5 bg-gray-100 dark:bg-slate-900 border-2 border-gray-700 rounded-xl text-cyber-text text-sm mb-2.5 focus:border-[#a78bfa] focus:outline-none"
            />
            <input
              type="password"
              value={newPassword}
        ...
        >
          ...
          >
            ...
            <input
              ...
              placeholder="새 학급 코드"
              className="w-full p-3.5 bg-gray-100 dark:bg-slate-900 border-2 border-gray-700 rounded-xl text-cyber-text text-sm mb-3 uppercase focus:border-[#a78bfa] focus:outline-none"
            />
            {error && <p className="text-red-500 text-[13px] mb-3">{error}</p>}
            <div className="flex gap-2.5">
              <button
        ...
        >
          ...
          >
            ...
            <input
              ...
              placeholder="계정삭제"
              className="w-full p-3.5 bg-gray-100 dark:bg-slate-900 border-2 border-red-500 rounded-xl text-cyber-text text-sm mb-2.5 focus:outline-none"
            />
            <input
              type="password"
              ...
              placeholder="비밀번호 확인"
              className="w-full p-3.5 bg-gray-100 dark:bg-slate-900 border-2 border-red-500 rounded-xl text-cyber-text text-sm mb-3 focus:outline-none"
            />
            {error && <p className="text-red-500 text-[13px] mb-3">{error}</p>}
            <div className="flex gap-2.5">
              <button
