...
const TUTORIAL_STEPS = [
  {
    ...
    description:
      "알찬은 학급 경제를 체험하며 배우는 교육 앱이에요. 함께 알아볼까요?",
    icon: Sparkles,
...
export function FeatureTooltip({
  ...
  return (
    ...
    >
      ...
      {show && (
        <div
          className={`absolute ${positionClasses[position]} left-1/2 -translate-x-1/2 w-48 p-3 bg-gray-100 text-slate-800 rounded-xl shadow-xl z-50`}
        >
