...
export default function AlchanLayout() {
  ...
  return (
    ...
    <ItemProvider>
      ...
      <div className="min-h-screen bg-slate-900 text-gray-100 font-sans selection:bg-indigo-500/30 selection:text-indigo-200 flex flex-col md:flex-row">
        {/* PC 사이드바 */}
        <AlchanSidebar
        ...
        {/* 메인 콘텐츠 영역 - 스크롤 문제 수정 */}
        <main
          className={`flex-1 min-w-0 md:min-h-screen relative bg-slate-900 ${
