            ...
            <div className="space-y-5">
              ...
              >
                ...
                >
                  ...
                  <p className="text-xs mt-1.5 ml-9" style={{ color: "#475569" }}>
                    세율과 주급 인상률을 설정합니다. 자동 주급 지급은 매주 <strong style={{ color: "#4338ca" }}>월요일 오전 8시 30분</strong>에 실행됩니다.
                  </p>
                </div>
              ...
              >
                ...
                <ul className="space-y-2 text-xs" style={{ color: "#334155" }}>
                  <li className="flex items-start gap-2">
                    ...
                    <span style={{ color: "#334155" }}>매주 <strong style={{ color: "#4338ca" }}>월요일 오전 8시 30분</strong>에 서버에서 자동으로 주급이 지급됩니다</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="shrink-0 mt-0.5">📈</span>
