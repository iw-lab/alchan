            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-600">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">글꼴 크기</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      읽기 편한 크기를 선택하세요
                    </p>
                  </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl divide-y divide-gray-200 dark:divide-gray-600">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="font-medium text-gray-900 dark:text-white">튜토리얼 다시 보기</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      사용법을 다시 배워요
                    </p>
                  </div>
              ...
              <div className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">앱 버전</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      v1.0.0
                    </p>
                  </div>
