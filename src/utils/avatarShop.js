...
// 베이스 대머리 인물: 정수리 ~20%, 눈 ~44%, 입 ~56%, 어깨 ~85%
// 헤어/모자는 정수리를 중심으로 머리 전체 영역 덮음
export const SLOT_ANCHORS = {
  base: { x: 50, y: 50, w: 100, h: 100 },     // 전체
  hair: { x: 50, y: 30, w: 80, h: 55 },       // 정수리 위~목 라인까지 (베이스 머리 영역 완전 덮음)
  hat: { x: 50, y: 15, w: 70, h: 32 },        // 정수리 최상단
  glasses: { x: 50, y: 44, w: 58, h: 18 },    // 눈 부분
  outfit: { x: 50, y: 87, w: 95, h: 30 },     // 어깨~상체
