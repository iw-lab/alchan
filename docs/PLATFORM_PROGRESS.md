...
- 방금 끝난 것 = **P1-5 교사 대시보드**(배포 전. 파일럿 게이트 ② 를 닫는다) — 아래 「P1-5 교사 대시보드」
- 다음 = **P1-4 파일럿**(구구성 수호대). 게이트 ②③ 이 닫힌 뒤에 연다.
...
| P1-5 | 교사 대시보드 — 학급 학습현황 + 보상 이상치 | ✅ **구현 완료(배포 전)** | 아래 「P1-5 구현」. 파일럿 게이트 ② 를 닫는 항목 |
...
| ② 환수 호출 경로 | 🟡 **구현 완료·배포 전**(2026-08-22 P1-5) | `/admin/learning-apps` 에서 지급 1건을 지목해 되돌린다. **배포해야 닫힌다** |
...
### ✅ P1-5 교사 대시보드 (2026-08-22) — 파일럿 게이트 ② 를 닫는다. 배포 전
