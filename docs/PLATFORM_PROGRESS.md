...
| 앱 | 기존(차단) | 변경 |
|---|---|---|
| 크로마폴 | `iw-lab.github.io/iswpurzzle/` | `chromafall.pages.dev` |
| 구구성 수호대 | `iw-lab.github.io/gugu-guardians/` | `gugu-guardians.pages.dev` |
...
### 🎮 P1-4b 앱이 토큰을 받는다 (2026-08-22) — 저장소 `iw-lab/gugu-guardians`
...
| 주소 | 번들 | 뜻 |
|---|---|---|
| `iw-lab.github.io/gugu-guardians/` | `index-B44uVdQg.js` | 학교망이 **막는** 주소. CI 가 여기로만 나간다 |
