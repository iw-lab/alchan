...
| `meta` | ✖ | 키 8개·문자열 120자까지. 원시 기록에만 남고 집계에는 안 들어간다 |
...
| 401 | 토큰 문제 | 알찬에서 다시 열게 한다 |
| 403 | `stats_off`·`disabled`·`not_migrated` | 조용히 기록을 포기한다 |
| 409 | 세션 문제(`session_missing`·`session_expired`) | 토큰을 새로 받는다 |
